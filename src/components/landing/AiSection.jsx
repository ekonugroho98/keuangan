        ...
        <section id="ai" style={{ padding: "80px 24px" }}>
            <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 48, alignItems: "center" }}>
                <FadeIn direction="right">
                    <span className="tag" style={{ background: "rgba(139,92,246,.1)", color: "#a78bfa" }}>{t("lp.ai.tag")}</span>
                    ...
                    <p style={{ color: "#94a3b8", lineHeight: 1.8, fontSize: 15, marginBottom: 28 }}>{t("lp.ai.desc")}</p>
                    {aiFeatures.map((f, i) => (
                        <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                            <span style={{ width: 22, height: 22, borderRadius: 6, background: "rgba(99,102,241,.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#818cf8" }}>✓</span>
                ...
                <FadeIn direction="left">
                    <GlowCard glowColor="rgba(139,92,246,.15)">
                        <div style={{ padding: 22 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, paddingBottom: 14, borderBottom: "1px solid rgba(255,255,255,.06)" }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize: 10, color: "#10b981" }}>{t("lp.ai.online")}</div>
                                </div>
                            </div>
                            ...
                            <div style={{ height: 220, overflowY: "auto", display: "flex", flexDirection: "column", gap: 10, marginBottom: 14 }}>
                                ...
                                {isTyping && (
                                    <div style={{ alignSelf: "flex-start", padding: "10px 14px", borderRadius: "14px 14px 14px 4px", background: "rgba(255,255,255,.05)", color: "#94a3b8", fontSize: 12 }}>
                            ...
                            <div style={{ display: "flex", gap: 8 }}>
                                ...
                                />
                                <button onClick={handleChat} style={{ width: 40, height: 40, borderRadius: 10, background: "linear-gradient(135deg,#6366f1,#8b5cf6)", border: "none", color: "#fff", fontSize: 16, cursor: "pointer" }}>↑</button>
                            </div>
                        </div>
                    </GlowCard>
                </FadeIn>
