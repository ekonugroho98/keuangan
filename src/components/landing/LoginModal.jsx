        ...
        {({ isDesktop }) => (
            <div style={{
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    ...
                    >
                        {isLoading
                            ? <><span style={{ width: 16, height: 16, border: "2px solid rgba(255,255,255,.3)", borderTopColor: "#fff", borderRadius: "50%", display: "inline-block", animation: "spin .8s linear infinite" }} />Masuk...</>
                            : "Masuk →"}
                    </button>
