        ...
        <div style={{ position: "relative" }}>
            ...
            <input
                ...
                style={{
                    ...
                    border: `1px solid ${error ? "rgba(255,113,108,0.5)" : "rgba(255,255,255,0.08)"}`,
                    background: "rgba(255,255,255,0.04)", color: "#e2e8f0",
                    fontSize: 16, outline: "none", transition: "all 0.3s",
                    boxSizing: "border-box", fontFamily: "inherit",
                }}
                onFocus={e => { e.target.style.borderColor = "rgba(96,252,198,0.5)"; e.target.style.boxShadow = "0 0 0 3px rgba(96,252,198,0.1)"; }}
                onBlur={e => { e.target.style.borderColor = error ? "rgba(255,113,108,0.5)" : "rgba(255,255,255,0.08)"; e.target.style.boxShadow = "none"; }}
            />
        </div>
