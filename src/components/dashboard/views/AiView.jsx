        ...
        <div style={{ background: "rgba(25,25,33,.6)", border: "1px solid rgba(255,255,255,.06)", borderRadius: 16, padding: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, paddingBottom: 16, borderBottom: "1px solid rgba(255,255,255,.06)" }}>
                ...
                <div>
                    ...
                    <div style={{ fontSize: 11, color: "var(--color-primary)" }}>● Online</div>
                </div>
            </div>
            ...
            <div style={{ height: 350, overflowY: "auto", display: "flex", flexDirection: "column", gap: 12, marginBottom: 16 }}>
                ...
                {aiTyping && (
                    <div style={{ alignSelf: "flex-start", padding: "12px 16px", borderRadius: "16px 16px 16px 4px", background: "rgba(255,255,255,.05)", color: "var(--color-muted)" }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
                {["Analisis spending gue", "Tips hemat", "Cek hutang gue", "Gimana saving rate gue?"].map((q, i) => (
                    <button key={i} onClick={() => setAiInput(q)} style={{ padding: "5px 12px", borderRadius: 16, border: "1px solid rgba(96,252,198,.2)", background: "rgba(96,252,198,.05)", color: "var(--color-primary)", fontSize: 11, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }}>{q}</button>
                ))}
            </div>
        </div>
    </div>
